...
class ExpandableNotifier extends StatefulWidget {
	...
	const ExpandableNotifier({
		...
		, required this.child        /// The child can be any widget which contains [Expandable] widgets in its widget tree.
...
class _ExpandableControllerNotifier extends InheritedNotifier<ExpandableController> {
	const _ExpandableControllerNotifier( {required ExpandableController? controller, required super.child}) : super(notifier: controller);
}
